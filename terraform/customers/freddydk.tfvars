...
windows_max_node_count = 10
windows_overprovision  = true  # Keep spare capacity (1 CPU + 4Gi) for instant pod scheduling
windows_spot_enabled        = true  # Add a Spot pricing Windows pool for lower cost
windows_spot_vm_size        = "Standard_D2ds_v6"
windows_spot_min_node_count = 2
windows_spot_max_node_count = 10
